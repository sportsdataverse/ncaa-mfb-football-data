"""Numbered stage shim: build the ``pbp`` dataset for one season.
...
no dataset reads another dataset's output).
    ...
    uv run python python/ncaa_mfb_04_pbp_creation.py --season 2025
"""
...
if __name__ == "__main__":
    raise SystemExit(main(["build", "--dataset", "pbp", *sys.argv[1:]]))
