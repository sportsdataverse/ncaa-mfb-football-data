"""Numbered stage shim: build the ``pbp_cfbfastr`` dataset for one season.
...
no dataset reads another dataset's output).
    ...
    uv run python python/ncaa_mfb_05_pbp_cfbfastr_creation.py --season 2025
"""
...
if __name__ == "__main__":
    raise SystemExit(main(["build", "--dataset", "pbp_cfbfastr", *sys.argv[1:]]))
