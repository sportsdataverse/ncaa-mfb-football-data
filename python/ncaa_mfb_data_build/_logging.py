...
Everything the pipeline reports flows through one ``ncaa_mfb_data_build`` logger
...
_FORMAT = "%(asctime)s [%(levelname)s] ncaa_mfb_data_build: %(message)s"
...
def get_logger() -> logging.Logger:
    ...
    logger = logging.getLogger("ncaa_mfb_data_build")
