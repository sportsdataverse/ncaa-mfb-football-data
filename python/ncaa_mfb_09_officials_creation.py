"""Numbered stage shim: build the ``officials`` dataset for one season.
...
no dataset reads another dataset's output).
    ...
    uv run python python/ncaa_mfb_09_officials_creation.py --season 2025
"""
...
if __name__ == "__main__":
    raise SystemExit(main(["build", "--dataset", "officials", *sys.argv[1:]]))
