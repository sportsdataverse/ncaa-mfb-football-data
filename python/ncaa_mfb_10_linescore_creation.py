"""Numbered stage shim: build the ``linescore`` dataset for one season.
...
no dataset reads another dataset's output).
    ...
    uv run python python/ncaa_mfb_10_linescore_creation.py --season 2025
"""
...
if __name__ == "__main__":
    raise SystemExit(main(["build", "--dataset", "linescore", *sys.argv[1:]]))
